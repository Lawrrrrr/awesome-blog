...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel bg-primary py-3">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <span class="font-weight-bold text-white">Tech&Tech</span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{ route('users.list') }}" class="nav-link text-white font-weight-bold">Users</a>
                            </li>
        ...
        {{-- <div class="footer footer-copyright text-center py-3 bg-primary">
